...
//   const [loadingProfilePic, setLoadingProfilePic] = useState(true); // Tracks profile picture loading status
...
//       } finally {
//         setLoadingProfilePic(false); // Stop loading when done
//       }
//     };
...
//       setImage(downloadURL); // Set the new image URL in state (Firebase URL)
//       setUploading(false);
...
//   },
//   profileImage: {
//     width: 100,  // Size for profile picture preview
//     height: 100,
...
const UploadMediaFile = () => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={Platform.OS === 'ios' ? 0 : 20} // Adjust offset for iOS/Android
    >
